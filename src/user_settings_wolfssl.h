/***************************************************************************//**
 * @file    user_settings_wolfssl.h
 * @brief   Arduino wolfSSL library user settings header
 * @author  onelife <onelife.real[at]gmail.com>
 ******************************************************************************/

#ifndef __USER_SETTINGS_WOLFSSL_H__
#define __USER_SETTINGS_WOLFSSL_H__
...
/* Override Memory API's */
    ...
    extern void rt_free(void *p);
    extern void *rt_realloc(void *p, unsigned int n);
...
#endif /* __USER_SETTINGS_WOLFSSL_H__ */
